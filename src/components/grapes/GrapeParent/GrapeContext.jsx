...
// const GrapeProvider = ({ children }) => {
//   // Functions for CRUD operations (to be implemented later)
//   const [grapes, setGrapes] = useState([]);
//   const [filteredGrapes, setFilteredGrapes] = useState([]);
//   const [searchQuery, setSearchQuery] = useState('');
...
//   // Fetch grapes on initial render
//   useEffect(() => {
//     fetchGrapes();
//   }, []);
...
//   return <GrapeContext.Provider value={value}>{children}</GrapeContext.Provider>;
// };
